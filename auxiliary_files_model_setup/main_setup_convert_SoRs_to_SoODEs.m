...
% BRAF, MEK, ERK, ATP, phosph1, phosph2, DBF, TMT (in bound and 
% unbound form) is conserved.
...
list_of_super_compounds=["BRAF";"MEK";"ERK";"ATP";"DBF";...
    "TMT";"phosph1";"phosph2"];
...
file_header_ode_math="function yp = " + file_name_math_yp + "(y, BRAF_in, ATP_in, DBF_in, TMT_in)";
