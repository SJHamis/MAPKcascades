...
%%%%%%%%%%%%%%%%%%%%%%% Generate activated substrate SUB (pSUB) vs t FIGURE for different SCH772984 values
...
for k = 1:4 
    ...
    ypsub = y(:,41)/1.2;
    ysub_pperk = y(:,39)/1.2;
    yatp_sub_pperk = y(:,40)/1.2;
    ypsub_phosph3 = y(:,43)/1.2;
    ysub_sch_pperk = y(:,46)/1.2;
    hold on
    plot(t,ysub,t,ypsub,t,ysub_pperk,t, ...
        yatp_sub_pperk,t,ypsub_phosph3,t, ...
        ysub_sch_pperk,'LineWidth',2.0)
    clear t y
...
lgd = legend('S', 'pS', 'S\cdot ppERK',  'ATP\cdot S\cdot ppERK', ...
    'pS\cdot phosph3','S\cdot SCH\cdot ppERK', ...
